...
\author{Luis  Menéndez , Manuel Lleonart-Anguix \thanks{Universitat Autònoma de Barcelona, CSIC and Barcelona School of Economics}} %omit the footnote and thanks if needed
\date{\today}
...
\begin{table}[ht]
	...
	\begin{minipage}{0.45\textwidth} 
		\centering
		\caption{BLP Estimation Results Pre-Campaign}
		\input{/Users/luisignaciomenendezgarcia/Dropbox/MediaBias/results/blp/tables/demo_pre_campaign.tex}
		\label{table:pre_campaign}
	\end{minipage}%
	\hfill
	\begin{minipage}{0.45\textwidth}
		\centering
		\caption{BLP Estimation Results Campaign}
		\input{/Users/luisignaciomenendezgarcia/Dropbox/MediaBias/results/blp/tables/demo_campaign.tex}
